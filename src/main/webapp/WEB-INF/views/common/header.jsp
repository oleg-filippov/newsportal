...
<div class="navbar-header">
	<a class="navbar-brand" href="${homeUrl}"><spring:message code="project.title" /></a>
</div>
<div class="navbar-collapse collapse">
	...
	<ul class="nav navbar-nav navbar-right">
		<sec:authorize access="isAnonymous()">
			<li><a href="${signupUrl}"><i class="glyphicon glyphicon-new-window"></i>
				<spring:message code="header.signup" /></a></li>
			<li><a href="${signinUrl}"><i class="glyphicon glyphicon-log-in"></i>
				<spring:message code="header.signin" /></a></li>
		</sec:authorize>
		<sec:authorize access="isAuthenticated()">
			<li class="dropdown">
				...
				<ul class="dropdown-menu">
					<li><a href="${profileUrl}/${loggedUser.id}">
						<i class="glyphicon glyphicon-user"></i>
							<spring:message code="header.profile" /></a></li>
					<li><a href="${logoutUrl}">
						<i class="glyphicon glyphicon-off"></i>
							<spring:message code="header.logout" /></a></li>
				</ul>
			</li>
		</sec:authorize>
